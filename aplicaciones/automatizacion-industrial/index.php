    ...
    <!-- ******************************************************** -->
        ...
        <section id="zonabanner-aplicacion">
            ...
            <div class="zonacentro ">
                ...
                <div class="titular">
                        <h2>AUTOMATIZACION INDUSTRIAL</h2>
        ...
        <section id="zona-aplicacion-introduccion">
            <div class="zonacentro">
                <h2>Introducción</h2>
                <p>Desarrollamos soluciones de automatización industrial que integran control lógico, supervisión, energía y comunicación en arquitecturas robustas y escalables.
                Diseñamos sistemas que conectan el nivel de campo con el centro de control, garantizando continuidad operativa y eficiencia en procesos críticos.
                </p>
            </div>
        </section>

        <section id="zona-aplicacion-escenarios">
            <div class="zonacentro">
                <h2>Aplicaciones y Escenarios</h2>
                <section class="escenarios">
                    <div class="escenario2">
                        
                        <h3>Control de Procesos y Producción</h3>
                        <p>
                            Control de Procesos y Producción
                            Automatización de líneas industriales
                            Control de motores, variadores y actuadores
                            Secuencias automáticas y lógica de proceso
                            Integración con sistemas de supervisión.
                            <br>
                            Escenarios: plantas manufactureras, procesos continuos y sistemas industriales complejos.
                        </p>
                    </div>
                    <div class="escenario2">
                        
                        <h3>Minería y Procesos Pesados</h3>
                        <p>
                            Control de sistemas de bombeo y ventilación
                            Supervisión de variables críticas en planta
                            Integración de sensores y equipos de campo
                            Comunicación con centros de control.
                            <br>
                            Escenarios: operaciones mineras, plantas concentradoras y sistemas de tratamiento.
                    ...
                    <div class="escenario2">
                        ...
                        <p>
                            Integración de tableros eléctricos inteligentes
                            Monitoreo de sistemas de respaldo energético
                            Automatización de subestaciones industriales
                            Supervisión de variables eléctricas en tiempo real.
                            <br>
                            Escenarios: empresas de energía, contratistas eléctricos industriales.
                    ...
                    <div class="escenario2">
                        ...
                        <h3>Supervisión, HMI y SCADA</h3>
                        <p>
                            Interfaces de operador industriales
                            Visualización en tiempo real
                            Gestión de alarmas e históricos
                            Integración con redes OT y sistemas IIoT.
                            <br>

                            Escenarios: centros de control y salas de supervisión industrial.
                    ...
                    <div class="escenario2">
                        ...
                        <p>
                            Arquitecturas PLC escalables
                            Integración con redes industriales
                            Diseño de tableros eléctricos a medida
                            Compatibilidad con protocolos de campo.
                            <br>
                            Preparado para integración con plataformas IIoT y energía industrial
