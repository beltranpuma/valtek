    ...
    <li class="droopmenu-parent">
        ...
        <main id="cuerpo">
            ...
            <div id="zona-productos">
                <div class="zonacentro">
                    <h2 class="titulo">Nuestra gama de productos de <span> Cellular Routers</span> </h2>
                    ...
                    <div class="lista-productos">
                        ...
                        <div class="producto">
                            <div class="slider-producto">
                                <div><img src="../../../assets/img-apps/categoria/cellular-routers/01-routers-celulares-industriales-estándar.png"></div>
                                <div><img src="../../../assets/img-apps/categoria/cellular-routers/02-routers-celulares-industriales-estándar.png"></div>
                            </div>
                            <div class="producto-info">
                                <h3>ROUTERS CELULARES INDUSTRIALES ESTÁNDAR</h3>
                                <ul class="caracteristicas">
                                    <li> Celular: 4G LTE Cat 4 / Cat 6*.</li>
                                    <li> WiFi: 802.11 b/g/n/ac*.</li>
                                    <li> VPN: IPsec, OpenVPN, L2TP, GRE.</li>
                                    <li>Enrutamiento dinámico: OSPF, RIP, BGP***</li>
                                    <li> Protocolos OT: MQTT, Modbus TCP</li>
                                    <li>Puertos: 2–4x Ethernet, RS-232/485*, USB.</li>
                        ...
                        <div class="producto">
                            <div class="slider-producto">
                                <div><img src="../../../assets/img-apps/categoria/cellular-routers/01-routers-celulares-rugged-rutdoor.png"></div>
                                <div><img src="../../../assets/img-apps/categoria/cellular-routers/02-routers-celulares-rugged-rutdoor.png"></div>
                            </div>
                            <div class="producto-info">
                                <h3>ROUTERS CELULARES RUGGED / OUTDOOR</h3>
                                <ul class="caracteristicas">
                                    <li> Celular: 4G LTE / 5G NR*.</li>
                                    <li> Bandas: Global multi-operador.</li>
                                    <li> VPN: IPsec (IKEv1/IKEv2), OpenVPN, GRE, DMVPN*.</li>
                                    <li> Enrutamiento dinámico: OSPF, BGP, VRRP, RIP*.</li>
                                    <li> Puertos: Ethernet industrial, M12*, SIM dual.</li>
                                    <li> Temperatura: -40 °C a +75 °C.</li>
                                    <li> Protección: IP65 / IP67.</li>
                                    <li>Alimentación: DC wide range / PoE*</li>
                                    <li>Montaje: Poste / muro / gabinete exterior</li>
                        ...
                        <div class="producto">
                            <div class="slider-producto">
                                <div><img src="../../../assets/img-apps/categoria/cellular-routers/01-routers-relulares-con-integración-ot.jpg"></div>
                                <div><img src="../../../assets/img-apps/categoria/cellular-routers/02-routers-relulares-con-integración-ot.png"></div>
                            </div>
                            <div class="producto-info">
                                <h3>ROUTERS CELULARES CON INTEGRACIÓN OT</h3>
                                <ul class="caracteristicas">
                                    <li> Celular: 4G LTE / 5G.</li>
                                    <li> VPN: IPsec, OpenVPN, SSL VPN</li>
                                    <li> Enrutamiento: OSPF, BGP, Static routing avanzado</li>
                                    <li> Protocolos industriales: Modbus TCP, MQTT, OPC UA*.</li>
                                    <li> Edge computing integrado.</li>
                                    <li> Interfaces: Ethernet, RS-232/485.</li>
                                    <li> Temperatura: -20 °C a +70 °C.</li>
