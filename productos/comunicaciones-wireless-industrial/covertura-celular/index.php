    ...
    <li class="droopmenu-parent">
        ...
        <main id="cuerpo">
            ...
            <div id="zona-productos">
                <div class="zonacentro">
                    <h2 class="titulo">Nuestra gama de productos de <span> Covertura Celular</span> </h2>
                    ...
                    <div class="lista-productos">
                        ...
                        <div class="producto">
                            <div class="slider-producto">
                                <div><img src="../../../assets/img-apps/categoria/covertura-celular/01-repetidor-celular-rf.png"></div>
                                <div><img src="../../../assets/img-apps/categoria/covertura-celular/02-repetidor-celular-rf.png"></div>
                            </div>
                            <div class="producto-info">
                                <h3>REPETIDORES CELULARES RF</h3>
                                <ul class="caracteristicas">
                                    <li> Mejora la señal celular resolviendo el problema de velocidad de datos, perdida de llamadas.</li>
                                    <li> Arquitectura: Repetidor RF convencional.</li>
                                    <li> Conexión: Antena donadora /coaxial / repetidor.</li>
                                    <li>Tecnologías: 2G / 3G / 4G LTE.</li>
                                    <li> Operadores compatibles: Movistar, Claro, Entel, Bitel.</li>
                                    <!-- <li> Cobertura: Limitada por pérdidas RF.</li>
                                            <li> Operación: Uplink / downlink simultáneo.</li> -->
                                    <li>Homlogados por el MTC.</li>
                                    <li>Cubre áreas: 100~400m2, 500~1000m2, 1000~3000m2, 5000~8000m2 y 15000~20000m2. </li>
                                    <li> Control: Ganancia automática (AGC)</li>
                                    <li> Diseño: Industrial.</li>
                                    <li>Aplicaciones: Oficinas, plantas pequeñas, almacenes.</li>
                                </ul>
                        ...
                        <!-- PRODUCTO 2 -->
                        <div class="producto">
                            <img src="../../../assets/img-apps/categoria/covertura-celular/01-repetidores-celulares-sobre-fibra-optica.png">
                            <div class="producto-info">
                                <h3>REPETIDORES CELULARES SOBRE FIBRA ÓPTICA (FIBER REPEATER)</h3>
                                <ul class="caracteristicas">
                                    <li> Extensión de señal celular a grandes distancias mediante fibra.</li>
                                    <li> Arquitectura: Antena donadora / Unidad Master / Fibra óptica / Unidad Remota.</li>
                                    <li> Medio: Fibra óptica monomodo / multimodo.</li>
                                    <li> Tecnologías: 2G / 3G / 4G LTE / 5G.</li>
                                    <li> Operadores compatibles: Movistar, Claro, Entel, Bitel.</li>
                                    <li> Alcance: Varios kilómetros sin degradación.</li>
                                    <li>Puede trasladar la cobertura de un lugar hasta 15Km de distancia con la fibra.</li>
                                    <li> Operación: Uplink / downlink simultáneo.</li>
                                    <li> Distribución: Antenas interiores desde unidad remota.</li>
                                    <li>Diseño: Industrial 24/7.</li>
                                    <li>Aplicaciones: Minería, túneles, plantas extensas, campus.</li>
                                </ul>
