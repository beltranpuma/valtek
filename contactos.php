            ...
            <section id="banner-contactos">
                <div class="zonacentro">
                    <div class="titular">
                        ...
                        <div class="linea"></div>
                        <a href="https://w.app/gqvbuy" target="_blank" class="btn-valtek">Contáctanos</a>
                    </div>
                </div>
                ...
                <div class="zonacentro" style="padding-top: 5px;">
                    ...
                    <div class="columnas ">
                        ...
                        <div class="col5" style="padding: 0 20px;">
                            <img src="assets/img-apps/contactos/img-contacto-artguru.webp" alt="Personal de soporte técnico y atención al cliente de Valtek Group" style="border-radius: 10px; width: 100%;">
                            <p style="font-weight: 800; margin-top: 20px;">Ubicanos :</p>
                            <p>
                                <i class="icon-localizar"></i> Av. Republica de Panamá 6598, Barranco - Lima<br>
                                <i class="icon-telefono"></i> 949 671 623<br>
                                <i class="icon-email"></i> ventas@valtek.com.pe
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div id="cajasociales">
            <div id="cajablanca">
                <ul>
                    ...
                    <li><a href="https://www.facebook.com/ValtekGroup" target="_blank"><span>Facebook</span></a></li>
        ...
        <script>
            $(function() {
                if (jQuery(this).scrollTop() > 100) {
                    jQuery(".droopmenu-navbar").css({'background': "rgba(255, 255, 255, 1)"});
                } else {
                    jQuery(".droopmenu-navbar").css({'background': "rgba(255, 255, 255, 1)"});
                }
                ...
                $("#biconos").click(function() {
                    $("#cajasociales").css({"right": "0"});
                })
                $("#cajasociales").click(function() {
                    $("#cajasociales").css({"right": "-100%"});
                })
